...
<head>
  ...
  <title>Sistema de Control de Producción | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html">Sistema de Producción <b>Gredos S.A</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    ?>
      <div class="form-group has-feedback">
        ...
        <input type="text" name="login" id="login" value="<?php echo set_value('login'); ?>" placeholder="Usuario" size="50" />
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      <?php echo form_error('password'); ?>
        <input type="password" name="password" id="password" value="" placeholder="Contraseña" size="50" />
